      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {results && !loading && (
          <div className="space-y-6 animate-fade-in">
            ...
            {/* AI Response & Actionable Checklist */}
    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        {messages.length === 0 && (
          <div className="text-center text-gray-500 mt-20">
            ...
            <p className="text-sm mt-2">Try typing: <i>"Email Rahul, PAN: ABCDE1234F"</i></p>
          </div>
        )}
      ...
      <div className="p-4 border-t border-gray-800 bg-[#121417]">
        <form onSubmit={onSubmit} className="flex items-center bg-[#1C1E24] border border-gray-700 rounded-xl p-2">
          <input type="text" value={input} onChange={handleInputChange} placeholder="💬 Type your secure message here..." className="flex-1 bg-transparent text-sm px-2 outline-none text-white placeholder-gray-500" />
...
export default function Home() {
  const [activeView, setActiveView] = useState('chat'); // 'chat' or 'seo'

  return (
    <div className="flex h-screen bg-[#0A0B0D] text-white font-sans">
      
      {/* LEFT SIDEBAR */}
      <div className="w-64 bg-[#121417] border-r border-gray-800 flex flex-col p-4 hidden md:flex">
      ...
      {/* MAIN AREA (Switches between Chat and SEO) */}
